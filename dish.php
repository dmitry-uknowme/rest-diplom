                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <text style="font-size: 15px;">
                                <?php echo '<ul class="ingridient-list" style="word-wrap:break-word">'; ?>
                       ...
                       <div class="col-lg-3">
                            <?php foreach ($prices as $price ) { ?>
                                <div class="col-lg-12 ingridient-price" data-price="<?php echo $price ?>">
                                    <div style="display: inline;"><?php echo ('<span class="ingridient-count-p">'.$price*1000 .'</span>' . 'р / 1000 г'); ?></div>
                                </div>
                            <?php } ?>
